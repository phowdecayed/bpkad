...
(function ($) {
    ...
    SEMICOLON.header = {
        ...
        menufunctions: function () {
            ...
            $('.menu-container:not(.mobile-primary-menu)').css({
                'display': ''
            });
            if ($body.hasClass('device-xl') || $body.hasClass('device-lg')) {
        ...
        fullWidthMenu: function () {
            ...
            if ($body.hasClass('device-md') || $body.hasClass('device-sm') || $body.hasClass('device-xs')) {
                $('.mega-menu-content, .top-search-form').css({
                    'width': ''
                });
                return true;
            }
            ...
            if ($header.find('.container-fullwidth').length > 0) {
                $('.mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content').css({
                    'width': headerWidth
                });
            }
            ...
            if ($body.hasClass('stretched')) {
                if ($header.hasClass('floating-header')) {
                    $('.mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content, .top-search-form').css({
            ...
            if ($window.scrollTop() > pageMenuOffset) {
                if ($body.hasClass('device-xl') || $body.hasClass('device-lg')) {
                    ...
                    if ($header.length > 0 && !$header.hasClass('no-sticky')) {
                        $pagemenu.filter('.sticky-page-menu:not(.dots-menu,.no-sticky)').find($pageMenuWrap).css({
                            'top': headerHeight + 'px'
                        });
                    }
                ...
                $pagemenu.find($pageMenuWrap).css({
                    'top': ''
                });
            }
        },
    ...
    SEMICOLON.slider = {
        ...
        sliderElementsFade: function () {
            ...
            if (($body.hasClass('device-xl') || $body.hasClass('device-lg')) && !SEMICOLON.isMobile.any()) {
                ...
                $sliderParallaxEl.filter('.slider-parallax-visible').find('.slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade').css({
                    'opacity': 1 - (((yScrollPosition - tHeaderOffset) * 1.85) / parallaxElHeight)
                });
            } else {
                $sliderParallaxEl.find('.slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade').css({
                    'opacity': 1
                });
            }
        },
