    ...
    <div class="login-box">
        ...
        <div class="login-logo">
            <a href="{{ '/' }}" style="color: orange;">
                <img src="{{ asset('assets/upload/image/'.website('logo')) }}" class="img img-responsive"
                    style="width: auto; max-width: 50%;">
            </a>
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="text-center link-bawah">
                    <a href="{{ asset('/') }}">Back to Homepage</a> | <a href="{{ asset('login/forgot') }}">Forgot
                        password?</a>
                </p>
