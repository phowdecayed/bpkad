...
<div class="form-group row">
	...
	<div class="col-md-9">
		<select name="halaman" class="form-control">
			...
			<option value="Tentang" <?php if($heading->halaman=="Tentang") { echo 'selected'; } ?>>Tentang</option>
			<option value="Team" <?php if($heading->halaman=="Team") { echo 'selected'; } ?>>Halaman Staff</option>
